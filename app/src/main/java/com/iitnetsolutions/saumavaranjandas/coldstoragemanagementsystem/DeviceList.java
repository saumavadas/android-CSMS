...
public class DeviceList extends ListActivity
{
    ...
    private int initDevicesList()
    {
        ...
        if (mBluetoothAdapter == null)
        {
            makeText(getApplicationContext(),
                    "Bluetooth not supported!!", LENGTH_LONG).show();
            return -1;
        }
        ...
        makeText(getApplicationContext(),
                "Getting all available Bluetooth Devices", LENGTH_SHORT)
                .show();
    ...
    private Runnable socketErrorRunnable = new Runnable()
    {
        ...
        public void run()
        {
            makeText(getApplicationContext(), "Cannot establish connection", LENGTH_SHORT).show();
            mBluetoothAdapter.startDiscovery();
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults)
    {
        switch (requestCode)
        {
            case REQUEST_COARSE_LOCATION:
                ...
                {
                    makeText(getApplicationContext(),
                            "Permission is not granted!", LENGTH_SHORT).show();
                    finish();
                }
                break;
            }
